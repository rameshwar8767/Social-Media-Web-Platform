        ...
        <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
            ...
            <div>
                ...
                bg-clip-text text-transparent">
                    More Than Friends — Build Real Connections
                </h1>
                <p className="text-base sm:text-lg md:text-2xl text-indigo-900 max-w-md leading-relaxed">
                Build meaningful connections with a global community on MeetUp
                </p>
            </div>
